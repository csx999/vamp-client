...
public class Main {
    public static void main(String[] args) throws UnsupportedLookAndFeelException, ClassNotFoundException, InstantiationException, IllegalAccessException {
        ...
        int option = JOptionPane.showOptionDialog(
                null,
                "To install Vamp Client you need to put it in your mods folder and run Fabric for latest Minecraft version.",
                "Meteor Client",
        ...
        switch (option) {
            case 0 -> Util.getOperatingSystem().open("https://github.com/MeteorDevelopment/vamp/wiki/Installation");
            case 1 -> {

package vampdev.vampclient.eventbus;

import vampdev.vampclient.eventbus.listeners.IListener;
import vampdev.vampclient.eventbus.listeners.LambdaListener;
...
public interface IEventBus {
     ...
     * @param packagePrefix Package prefix that this factory will be used for, eg "mathax.client.eventbus"

...
package vampdev.vampclient.gui.renderer;

import vampdev.vampclient.gui.GuiTheme;
import vampdev.vampclient.gui.renderer.operations.TextOperation;
import vampdev.vampclient.gui.renderer.packer.GuiTexture;
import vampdev.vampclient.gui.renderer.packer.TexturePacker;
...
import vampdev.vampclient.renderer.Texture;
...
import vampdev.vampclient.utils.render.ByteTexture;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(new Identifier("vamp", "textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(new Identifier("vamp", "textures/icons/gui/triangle.png"));
        EDIT = addTexture(new Identifier("vamp", "textures/icons/gui/edit.png"));
        RESET = addTexture(new Identifier("vamp", "textures/icons/gui/reset.png"));

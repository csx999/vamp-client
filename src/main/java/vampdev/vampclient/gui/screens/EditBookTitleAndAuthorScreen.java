...
public class EditBookTitleAndAuthorScreen extends WindowScreen {
    ...
    public void initWidgets() {
        ...
        t.add(theme.button("Done")).expandX().widget().action = () -> {
            ...
            VampClient.mc.getNetworkHandler().sendPacket(new BookUpdateC2SPacket(hand == Hand.MAIN_HAND ? VampClient.mc.player.getInventory().selectedSlot : 40, pages, Optional.of(title.get())));

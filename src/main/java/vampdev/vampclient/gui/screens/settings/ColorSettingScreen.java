...
public class ColorSettingScreen extends WindowScreen {
    ...
    public boolean toClipboard() {
        ...
        VampClient.mc.keyboard.setClipboard(color);
        return VampClient.mc.keyboard.getClipboard().equals(color);
    }

    @Override
    public boolean fromClipboard() {
        String clipboard = VampClient.mc.keyboard.getClipboard().trim();
        SettingColor parsed;

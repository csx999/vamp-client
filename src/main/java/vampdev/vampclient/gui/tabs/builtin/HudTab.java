...
public class HudTab extends Tab {
    ...
    public void openScreen(GuiTheme theme) {
        VampClient.mc.setScreen(createScreen(theme));
    }
    ...
    public static class HudScreen extends WindowTabScreen {
        ...
        protected void init() {
            ...
            VampClient.mc.options.hudHidden = false;
        }
        ...
        public void onClose() {
            ...
            if (theme.hideHUD() && parent instanceof WidgetScreen) VampClient.mc.options.hudHidden = true;
        }
        ...
        public boolean mouseClicked(double mouseX, double mouseY, int button) {
            if (hoveredModule != null) {
                if (button == GLFW.GLFW_MOUSE_BUTTON_RIGHT) {
                    ...
                    VampClient.mc.setScreen(new HudElementScreen(theme, hoveredModule));
                }
                else {
                    dragging = true;
                    dragged = false;

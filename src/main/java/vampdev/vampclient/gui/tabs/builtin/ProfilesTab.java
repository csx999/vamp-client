    ...
    private static class ProfilesScreen extends WindowTabScreen {
        ...
        public void initWidgets() {
            ...
            for (Profile profile : Profiles.get()) {
                ...
                edit.action = () -> VampClient.mc.setScreen(new EditProfileScreen(theme, profile, this::reload));
            ...
            create.action = () -> VampClient.mc.setScreen(new EditProfileScreen(theme, null, this::reload));
        }

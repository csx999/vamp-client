...
public class WVampDropdown<T> extends WDropdown<T> implements VampWidget {
    public WVampDropdown(T[] values, T value) {
        super(values, value);
    }
    ...
    private static class WRoot extends WDropdownRoot implements VampWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            VampGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements VampWidget {
        @Override

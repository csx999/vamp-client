...
import vampdev.vampclient.renderer.Renderer3D;
import vampdev.vampclient.systems.modules.Modules;
import vampdev.vampclient.systems.modules.player.LiquidInteract;
import vampdev.vampclient.systems.modules.player.NoMiningTrace;
...
public abstract class GameRendererMixin {
    ...
    private void onRenderWorld(float tickDelta, long limitTime, MatrixStack matrices, CallbackInfo info, boolean bl, Camera camera, MatrixStack matrixStack, double d, float f, Matrix4f matrix4f) {
        ...
        client.getProfiler().push("vamp_render");
    ...
    private void onRenderWorldTail(CallbackInfo info) {
        VampClient.EVENT_BUS.post(RenderAfterWorldEvent.get());
    }

...
import vampdev.vampclient.utils.misc.MeteorStarscript;
...
public class DiscordPresence extends Module {
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (Utils.canUpdate()) {
            ...
            if (!lastWasInMainMenu) {
                rpc.details = "Vamp Client " + (Config.get().devBuild.isEmpty() ? Config.get().version : Config.get().version + " " + Config.get().devBuild);
    ...
    public WWidget getWidget(GuiTheme theme) {
        ...
        help.action = () -> Util.getOperatingSystem().open("https://github.com/MeteorDevelopment/vamp/wiki/Starscript");

...
import vampdev.vampclient.systems.modules.movement.elytrafly.modes.Packet;
import vampdev.vampclient.systems.modules.movement.elytrafly.modes.Pitch40;
import vampdev.vampclient.systems.modules.movement.elytrafly.modes.Vanilla;
import vampdev.vampclient.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        VampClient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        VampClient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        VampClient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        VampClient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }

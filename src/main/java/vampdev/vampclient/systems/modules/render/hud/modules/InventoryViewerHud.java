...
public class InventoryViewerHud extends HudElement {
    private static final Identifier TEXTURE = new Identifier("vamp", "textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = new Identifier("vamp", "textures/container-transparent.png");

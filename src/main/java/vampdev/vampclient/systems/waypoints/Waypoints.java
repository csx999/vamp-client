...
package vampdev.vampclient.systems.waypoints;
...
import vampdev.vampclient.utils.misc.Vec3;
import vampdev.vampclient.utils.player.PlayerUtils;
import vampdev.vampclient.utils.render.NametagUtils;
import vampdev.vampclient.utils.render.color.Color;
import vampdev.vampclient.utils.world.Dimension;
...
public class Waypoints extends System<Waypoints> implements Iterable<Waypoint> {
    ...
    @Override
    public void init() {
        File iconsFolder = new File(new File(VampClient.FOLDER, "waypoints"), "icons");
        iconsFolder.mkdirs();
    ...
    public File getFile() {
        ...
        return new File(new File(VampClient.FOLDER, "waypoints"), Utils.getWorldName() + ".nbt");
    }
    ...
    private void copyIcon(File file) {
        StreamUtils.copy(Waypoints.class.getResourceAsStream("/assets/vamp/textures/icons/waypoints/" + file.getName()), file);
    }
}

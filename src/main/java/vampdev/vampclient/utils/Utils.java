...
import vampdev.vampclient.mixin.ClientPlayNetworkHandlerAccessor;
import vampdev.vampclient.mixin.MinecraftClientAccessor;
import vampdev.vampclient.mixin.MinecraftServerAccessor;
import vampdev.vampclient.mixininterface.IMinecraftClient;
import vampdev.vampclient.systems.modules.Modules;
import vampdev.vampclient.systems.modules.render.BetterTooltips;
import vampdev.vampclient.systems.modules.world.Timer;
import vampdev.vampclient.utils.player.EChestMemory;
import vampdev.vampclient.utils.render.PeekScreen;
import vampdev.vampclient.utils.render.color.Color;
import vampdev.vampclient.utils.world.BlockEntityIterator;
import vampdev.vampclient.utils.world.ChunkIterator;
...
public class Utils {
    ...
    public static void init() {
        VampClient.EVENT_BUS.subscribe(Utils.class);
    }

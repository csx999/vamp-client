...
public class PacketUtils {
    ...
    static {
        ...
        S2C_PACKETS.put(net.minecraft.network.packet.s2c.play.VibrationS2CPacket.class, "VibrationS2CPacket");
        ...
        S2C_PACKETS_R.put("VibrationS2CPacket", net.minecraft.network.packet.s2c.play.VibrationS2CPacket.class);
    ...
    private static class PacketRegistry extends Registry<Class<? extends Packet<?>>> {
        public PacketRegistry() {
            super(RegistryKey.ofRegistry(new Identifier("vamp", "packets")), Lifecycle.stable());
        }
        ...
        @Override
        public Class<? extends Packet<?>> getRandom(Random random) {
            return null;
        }

...
import vampdev.vampclient.systems.modules.movement.NoFall;
import vampdev.vampclient.utils.Utils;
import vampdev.vampclient.utils.entity.EntityUtils;
import vampdev.vampclient.utils.misc.BaritoneUtils;
import vampdev.vampclient.utils.misc.text.TextUtils;
...
public class PlayerUtils {
    ...
    public static Color getPlayerColor(PlayerEntity entity, Color defaultColor) {
        ...
        if (!color.set(TextUtils.getMostPopularColor(entity.getDisplayName())).equals(Utils.WHITE) && Config.get().useTeamColor) return color.set(color).a(defaultColor.a);
        return defaultColor;
    }
